...
import { Minecraft, MinecraftGui, Gametest, dim, VanillaWorld, VanillaScoreboard, VanillaEvents, MinecraftSystem, runTask, SystemEvents } from "./basis.js";
...
function openShell(sender) {
    ...
    if (linesLimit < 0) {
        gui.textField("已忽略的输出行", "", `[还有${0 - linesLimit}行输出未显示]`);
    }
    optLines.shift();
